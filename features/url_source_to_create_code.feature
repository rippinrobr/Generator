Feature: Create Code from a URL Source
  ...
  Scenario Outline:  Read data from a URL that returns JSON
    ...
    Scenarios:  valid options
      ...
      | http://localhost:3000/percentiles/era_season/1979_AL | ruby | seasonal_era_percentile.rb | /tmp | seasonal_era_percentile_service.rb | /tmp | src |
      #| http://localhost:3000/percentiles/era_season/1979_AL | c_sharp | SeasonalEraPercentile.cs | /tmp | SeasonalEraPercentileService.cs | /tmp | src |
